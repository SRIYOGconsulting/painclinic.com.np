...
export const blogs = [
  {
    title: "Headache",
    description: "How Weather Changes Trigger Headaches: Causes and Solutions",
    image: headacheImg,
    time: "2 Minutes Read",
  ...
  {
    title: "Neck Pain",
    description: "Neck Pain: Causes of neck pain during the monsoon season",
    image: neckImg,
    time: "2 Minutes Read",
  ...
  {
    title: "Joint Pain",
    description: "Joint Care: How to Protect Your Joints",
    image: jointImg,
    time: "3 Minutes Read",
  ...
  {
    title: "Shoulder Pain",
    description: "Shoulder Pain and Cold Weather: Understanding the Connection",
    image: shoulderImg,
    time: "2 Minutes Read",
  ...
  },
  {
    ...
    description: "The Winter Chill and Orofacial Pain: Causes and Care",
    image: orofacial,
    time: "2 Minutes Read",
  ...
  {
    title: "Knee Pain",
    description: "Winter and Knee Pain: Why It Happens and What You Can Do",
    image: knee,
    time: "2 Minutes Read",
  ...
  },
  {
    ...
    description: "Winter and Nerve Pain: Understanding the Triggers",
    image: nerve,
    time: "2 Minutes Read",
  ...
  {
    title: "Muscle Pain",
    description: "Muscle Pain: Symptoms and causes",
    image: muscle,
    time: "3 Minutes Read",
  ...
  {
    title: "Sports Injury",
    description: "Preventing Sports Injuries During Outdoor Activities.",
    image: sports,
    time: "3 Minutes Read",
  ...
  },
  {
    ...
    description: "Understanding Chronic Whole Body Pain: When to Seek Help",
    image: whole,
    time: "3 Minutes Read",
  ...
  {
    title: "Cancer Pain",
    description: "Comprehensive Pain Management for Cancer Patients",
    image: cancer,
    time: "3 Minutes Read",
        ...
        {blogs.map((blog, index) => (
          ...
          >
            ...
            >
              ...
              <div className="absolute inset-0 bg-blue-600 opacity-0 group-hover:opacity-40 transition-opacity duration-300 rounded-xl" />
            </motion.div>
            ...
            <div className="flex items-center gap-6 text-[11px] text-gray-600 mt-3">
              <div className="flex items-center gap-2">
                <img src={UserRound} alt="userround" className="w-4 h-4" />
                <span>Advance Pain Clinic</span>
              </div>

              <div className="flex items-center gap-2">
                <img src={MessageCircleMore} alt="message circle more" className="w-4 h-4" />
                <span>{blog.time}</span>
              </div>
            </div>
          </Link>
