  ...
  return (
    <div className="max-w-5xl mx-auto px-6 py-20 text-[#707882] font-[sans-serif]">
      ...
      <div className="my-4">
        <img
          src={muscle}
          alt="Person holding their back due to muscle pain"
      ...
      <p className="mb-10 leading-relaxed text-[#707882]">
        Muscle pain can be caused by overuse, strain, or injury. It can occur in any muscle in the body, resulting in stiffness, soreness, and limited mobility. Conditions like fibromyalgia, muscle cramps, and overexertion are common causes of muscle pain.
      </p>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
            ...
            <div className="ml-4 flex flex-col">
              ...
              <div className="mt-2 border-l-2 border-gray-300 pl-4">
                <p className="text-[#707882]">
                  Muscle pain can result from overuse, injury, strain, or conditions like fibromyalgia or myositis.
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="flex items-start">
            ...
            <div className="ml-4 flex flex-col">
              ...
              <div className="mt-2 border-l-2 border-gray-300 pl-4">
                <p className="text-[#707882]">
                  Symptoms include soreness, tenderness, swelling, and stiffness in the affected muscles.
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="flex items-start">
            ...
            <div className="ml-4 flex flex-col">
              ...
              <div className="mt-2 border-l-2 border-gray-300 pl-4">
                <p className="text-[#707882]">
                  Treatment includes rest, stretching, over-the-counter pain relievers, heat or ice therapy, and physical therapy.
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="flex items-start">
            ...
            <div className="ml-4 flex flex-col">
              ...
              <div className="mt-2 border-l-2 border-gray-300 pl-4">
                <p className="text-[#707882]">
                  If the pain is severe, persistent, or caused by an injury, you should see a doctor.
                </p>
              </div>
            </div>
          </div>
          <div className="flex items-start">
            ...
            <div className="ml-4 flex flex-col">
              ...
              <div className="mt-2 border-l-2 border-gray-300 pl-4">
                <p className="text-[#707882]">
                  Mild soreness is common after new or intense workouts.
Proper warm-up, cool-down, and hydration help prevent it.
                </p>
              </div>
            </div>
          </div>
          <div className="flex items-start">
            ...
            <div className="ml-4 flex flex-col">
              ...
              <div className="mt-2 border-l-2 border-gray-300 pl-4">
                <p className="text-[#707882]">
                  Yes, lack of water can lead to cramps and stiffness.
Staying hydrated supports proper muscle function.
                </p>
              </div>
            </div>
          </div>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
          ...
          <div className="bg-gray-100 p-4 rounded-lg shadow-md">
            ...
            <p className="text-[#707882] py-3">
              Nerve pain often accompanies muscle pain, especially in cases of sciatica or compression injuries.
            </p>
          ...
          <div className="bg-gray-100 p-4 rounded-lg shadow-md">
            ...
            <p className="text-[#707882] py-3">
              Back pain often leads to muscle strain, especially in the lower back area, and can contribute to discomfort.
            </p>
          ...
          <div className="bg-gray-100 p-4 rounded-lg shadow-md">
            ...
            <p className="text-[#707882] py-3">
              Muscle pain in the legs, especially around the knees, can limit movement and increase discomfort in joint areas.
            </p>
