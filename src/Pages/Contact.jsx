    ...
    <div className="bg-[#eef3f9] min-h-screen mt-20 font-[sans-serif]">
      ...
      <div className="mt-16 max-w-6xl mx-auto px-6">
        <div className="bg-white rounded-3xl shadow-lg overflow-hidden">
          <div className="p-8">
            <h2 className="text-2xl font-bold text-[#1d2c4b] mb-4">Find Us on Map</h2>
            <p className="text-gray-600 mb-6">Visit our clinic at Birtamode, Jhapa, Nepal</p>
          </div>
          <div className="relative h-96 lg:h-[500px]">
            <iframe 
              src="https://www.google.com/maps/embed?pb=!1m23!1m12!1m3!1d114119.01942035899!2d87.90179141821416!3d26.641458251071874!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!4m8!3e6!4m0!4m5!1s0x39e5bb007acd06ab%3A0xca6d4798d37c7569!2sJXRM%2BHMW%20Advance%20Pain%20Specialist%20Clinic%201%2C%20Mahendra%20Hwy%2C%20Birtamod%2057206!3m2!1d26.641517999999998!2d87.98420329999999!5e0!3m2!1sen!2snp!4v1763392465591!5m2!1sen!2snp" 
              className="absolute inset-0 w-full h-full border-0"
              allowFullScreen=""
              loading="lazy"
              referrerPolicy="no-referrer-when-downgrade"
              title="Advance Pain Specialist Clinic Location"
            />
          </div>
          <div className="p-8 bg-gray-50">
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6 text-center">
              <div>
                <h3 className="font-semibold text-[#1d2c4b] mb-2">Exact Location</h3>
                <p className="text-gray-600 text-sm">Mahendra Hwy, Birtamod 57206</p>
              </div>
              <div>
                <h3 className="font-semibold text-[#1d2c4b] mb-2">Landmark</h3>
                <p className="text-gray-600 text-sm">Near Birtamode City Center</p>
              </div>
              <div>
                <h3 className="font-semibold text-[#1d2c4b] mb-2">Parking Available</h3>
                <p className="text-gray-600 text-sm">Free parking for patients</p>
              </div>
            </div>
          </div>
        </div>
